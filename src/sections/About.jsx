...
const SVGComponent = () => {
  return (
    ...
    >
      ...
      >
        Take mouse HERE - ❛❛ Objects are Larger THAN they Appear 😆 ❜❜
      </text>
    </svg>
  );
};
        ...
        <div className='sm:max-w-xl max-w-full'>
          <div className='grid-container'>
              ...
              <div className='font-thin text-3xl text-white text-justify'>
                  ...
                  <TextEffect per='word' as='h3' preset='slide'> ❛❛ Bridging Gap between Innovation and Application by Levaraging AI Toolings ❜❜</TextEffect>
              </div>
            </div>
        </div>
